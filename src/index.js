...
// 6. Set up a resolver for the Post comments field that returns all the comments belonging to that post.
// 7. Run a sample query that gets all the posts and all their comments.
